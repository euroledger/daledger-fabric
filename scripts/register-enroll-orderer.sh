...
function    checkCopyYAML {
    SETUP_CONFIG_CLIENT_YAML="./ca-client/client/orderer/fabric-ca-client-config.yaml"
...
function    setFabricCaClientHome {
    CA_CLIENT_FOLDER="./ca-client/client/orderer"
...
echo "Important: copying from " $ADMIN_CLIENT_HOME " to " $FABRIC_CA_CLIENT_HOME
