...
function    setFabricCaClientHome {
    CA_CLIENT_FOLDER="../ca-client/client/$ORG_NAME"
...
echo "make directory $FABRIC_CA_CLIENT_HOME/msp/admincerts"
mkdir -p $FABRIC_CA_CLIENT_HOME/msp/admincerts
echo "copy $ADMIN_CLIENT_HOME/msp/signcerts/* to $FABRIC_CA_CLIENT_HOME/msp/admincerts"
